  ...
  return (
    <div class="relative flex-1 h-screen w-screen min-h-0 flex flex-col items-center justify-center bg-background-base font-sans">
      <div class="w-2/3 max-w-3xl flex flex-col items-center justify-center gap-8">
        <div class="opacity-12 shrink-0 flex items-center gap-3">
          <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="6" y="4" width="26" height="32" rx="3" stroke="currentColor" stroke-width="2.5"/>
            <line x1="12" y1="13" x2="28" y2="13" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
            <line x1="12" y1="19" x2="28" y2="19" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
            <line x1="12" y1="25" x2="22" y2="25" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
          </svg>
          <span class="text-4xl font-semibold tracking-tight text-text-strong">PaperStudio</span>
        </div>
