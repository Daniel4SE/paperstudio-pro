...
export function SessionHeader() {
  ...
  const switchToPaper = () => {
    navigate(`/${params.dir}/paper/${params.id ?? ""}`)
  }
          ...
          <Portal mount={mount()}>
            <div class="flex items-center gap-2">
              <Button
                variant="ghost"
                size="small"
                class="h-[24px] px-2.5 rounded-md border border-border-weak-base bg-surface-panel shadow-none gap-1.5"
                onClick={switchToPaper}
              >
                <Icon name="code" size="small" class="icon-base" />
                <span class="text-12-regular">Paper</span>
              </Button>
              <StatusPopover />
